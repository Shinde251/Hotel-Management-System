...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:jalgaon@gmail.com.com">chetanshinde@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 9011115729</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Chetan <span>Patil</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/teams.jp" alt=" " class="img-responsive" />
					</li>
					<li>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 9011115729</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="Chetanshinde@gmail.com.com">Chetanshinde@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Dnyandeo Nagar ,jalgaon</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2022 chetan patil . All Rights Reserved | Design by <a href="index.php">Chetan Patil</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
